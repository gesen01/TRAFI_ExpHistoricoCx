...
BEGIN
	...
	BEGIN
		INSERT INTO TRAFIMARHistSaldosCx(IDOrigen,FechaEmision, Mov, MovID, Cliente,Nombre,Moneda,SubTotal,Impuestos,Total,
				 						TipoCambio,SubTotalMN,ImpuestosMN,TotalMN,Saldo,Descripcion,Concepto,Sucursal,CentroCosto
				...
				SELECT c.ID,c.FechaEmision,c.Mov,c.MovID,c.Cliente,t.Nombre,c.Moneda,c.importe,c.impuestos
					   ...
					   ,SUM(COALESCE(e.Abono,a.Cargo,0)) OVER (PARTITION BY ISNULL(e.Aplica,a.Mov), ISNULL(e.AplicaID,a.MovID) ORDER BY ISNULL(e.Fecha,a.Fecha)
